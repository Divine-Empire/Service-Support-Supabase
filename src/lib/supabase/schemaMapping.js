...
export const SCHEMA_MAPPING = {
  ...
  invoice: {
    ...
    fields: [
      ...
      { sheetColumn: null, sheetIndex: null, sheetField: "attachmentSpare", supabaseColumn: "attachment_spare", type: "text", note: "Same Storage bucket/prefix as attachment_service." },
